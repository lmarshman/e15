...
class ListController extends Controller
{
    ...
    // Displays page for user to add notes to a new list item. Also checks if location is already
    // on their list.
    ...
    // API call to get the address for locations generated by the Places API
    ...
    // Function responsible for formatting API response from getAddress()
    // The locations from the Places API are missing a good amount of information and this allows them 
    // to be entered into the database while still having good data.
    public function addPlaceToList(Request $request, $lat, $long, $name)
    {
        // Call to API to get the address information
        $placeAddress = self::getAddress($lat, $long);
        $arr = json_decode($placeAddress, true);

        // Formatting address for street number and name
        ...
        // Returns variables so that addToList form  for locations generated by Places API
        // can be pre-filled with the below information.
    ...
    // Processes form data from the addToList form  for locations generated by Places API
    ...
    // Adds location to user list that are from the DB
    ...
    // Allows a user to update their notes for a location on their list
    ...
    // Displays page to verify that a user wants to delete a location from their list
    ...
    // Deletes location from user list
